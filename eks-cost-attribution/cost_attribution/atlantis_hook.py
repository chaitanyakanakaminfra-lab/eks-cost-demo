...
class AtlantisHook:
    def __init__(self):
        ...
        owner        = os.environ.get("BASE_REPO_OWNER", "")
        repo         = (os.environ.get("ATLANTIS_REPO_NAME") or os.environ.get("BASE_REPO_NAME", ""))
        self.repo    = f"{owner}/{repo}" if owner and repo else repo
